...
},{"react":"../node_modules/react/index.js"}],"components/Artists.js":[function(require,module,exports) {
"use strict";
...
var API_URL = "https://spotify-api-wrapper.appspot.com";
...
function (_React$Component) {
  ...
  function App() {
    ...
    _defineProperty(_assertThisInitialized(_this), "searchArtist", function (artistQuery) {
      fetch("".concat(API_URL, "/artist/").concat(artistQuery)).then(function (response) {
        ...
        if (json.artists.total > 0) {
          ...
          fetch("".concat(API_URL, "/artist/").concat(artist.id, "/top-tracks")).then(function (response) {
            return response.json();
          }).then(function (json) {
...
var _default = App;
exports.default = _default;
},{"react":"../node_modules/react/index.js","./Search":"components/Search.js","./Artists":"components/Artists.js","./Tracks":"components/Tracks.js"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
_reactDom.default.render(_react.default.createElement(_App.default, null), document.getElementById("root")); // new Promise((resolve, reject) => {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "63672" + '/');
